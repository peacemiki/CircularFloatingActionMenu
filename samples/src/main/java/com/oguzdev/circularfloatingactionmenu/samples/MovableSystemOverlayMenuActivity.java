...
public class MovableSystemOverlayMenuActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent is = new Intent(MovableSystemOverlayMenuActivity.this, MovableSystemOverlayMenuService.class);
                startService(is);
